import torch
from model import ChunkedRotary
...
def test_chunked_rotary():
    ...
    rotary_chunked = ChunkedRotary(dim=head_dim, max_seq_len=chunk_size, chunked=True)
...
def test_regular_rotary():
    ...
    rotary_regular = ChunkedRotary(dim=head_dim, max_seq_len=seq_len, chunked=False)
